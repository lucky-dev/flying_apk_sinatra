...
describe AndroidApp do
  ...
  describe 'is valid' do
    ...
    it 'and has builds' do
      ...
      @build = Build.create(name: 'Build #1', version: '1.0', fixes: 'Some fixes', type: 'debug', created_time: Time.now.utc, file_name: 'my_app.apk', file_checksum: 'ea6e9d41130509444421709610432ee1')
